...
public class RedisConfiguration {
    ...
    public Jackson2JsonRedisSerializer<Object> getJacksonToJsonSerializable(){
    ...
    public CacheManager getCacheManager(RedisConnectionFactory redisConnectionFactory){
        ...
        Jackson2JsonRedisSerializer<Object> jackson2JsonRedisSerializer = getJacksonToJsonSerializable();
